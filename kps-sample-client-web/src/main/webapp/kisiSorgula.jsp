...
<body>
	<h2 style="text-align: center;">T.C. Kimlik No ile Kişi Bilgisi Sorgulama</h2>
	<f:view>
		<h:form id="form">
			...
			<table style="width: 30%">
				...
				<tr>
					...
					<td class="deger">
						<h:inputText value="#{kisiSorgulamaBean.tcKimlikNo}"></h:inputText>
					</td>
				</tr>
				<tr>
					<td colspan="2" style="text-align: right;">
						<h:commandButton value="Sorgula" action="#{kisiSorgulamaBean.sorgula}"></h:commandButton>
					</td>
				</tr>
				<tr>
