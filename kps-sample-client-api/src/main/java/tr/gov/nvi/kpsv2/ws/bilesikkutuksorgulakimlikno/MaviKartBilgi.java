    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "Birim", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "KartKayitNo", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "No", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
    protected JAXBElement<Integer> no;
    @XmlElementRef(name = "OncekiSoyad", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
    protected JAXBElement<String> oncekiSoyad;
    @XmlElementRef(name = "Seri", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "VerilisNeden", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
    protected JAXBElement<Parametre> verilisNeden;
    @XmlElementRef(name = "VerilmeTarih", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
