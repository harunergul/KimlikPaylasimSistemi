 ...
 *         &lt;element name="MaviKartliKisiKutukleri" type="{http://kps.nvi.gov.tr/2011/01/01}MaviKartKisiKutukleri" minOccurs="0"/>
 *         &lt;element name="TCVatandasiKisiKutukleri" type="{http://kps.nvi.gov.tr/2011/01/01}TCVatandasiKisiKutukleri" minOccurs="0"/>
 *         &lt;element name="YabanciKisiKutukleri" type="{http://kps.nvi.gov.tr/2011/01/01}YabanciKisiKutukleri" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "MaviKartliKisiKutukleri", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
    protected JAXBElement<MaviKartKisiKutukleri> maviKartliKisiKutukleri;
    @XmlElementRef(name = "TCVatandasiKisiKutukleri", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
    protected JAXBElement<TCVatandasiKisiKutukleri> tcVatandasiKisiKutukleri;
    @XmlElementRef(name = "YabanciKisiKutukleri", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
