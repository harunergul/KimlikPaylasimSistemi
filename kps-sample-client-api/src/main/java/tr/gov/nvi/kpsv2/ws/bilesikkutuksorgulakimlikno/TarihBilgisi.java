    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "Ay", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
    protected JAXBElement<Integer> ay;
    @XmlElementRef(name = "Gun", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
    protected JAXBElement<Integer> gun;
    @XmlElementRef(name = "Yil", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
