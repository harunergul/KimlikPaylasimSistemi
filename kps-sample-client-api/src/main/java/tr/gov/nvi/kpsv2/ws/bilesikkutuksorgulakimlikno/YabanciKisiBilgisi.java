    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "AnneKimlikNo", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
    protected JAXBElement<Long> anneKimlikNo;
    @XmlElementRef(name = "BabaKimlikNo", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
    protected JAXBElement<Long> babaKimlikNo;
    @XmlElementRef(name = "BitisTarihiBelirsizOlmaNeden", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "EsKimlikNo", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
    protected JAXBElement<Long> esKimlikNo;
    @XmlElementRef(name = "GercekKisiKimlikNo", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "IzinBaslangicTarih", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
    protected JAXBElement<XMLGregorianCalendar> izinBaslangicTarih;
    @XmlElementRef(name = "IzinBitisTarih", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
    protected JAXBElement<XMLGregorianCalendar> izinBitisTarih;
    @XmlElementRef(name = "IzinDuzenlenenIl", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
    protected JAXBElement<Parametre> izinDuzenlenenIl;
    @XmlElementRef(name = "IzinNo", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
    protected JAXBElement<String> izinNo;
    @XmlElementRef(name = "KaynakBirim", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
    protected JAXBElement<Parametre> kaynakBirim;
    @XmlElementRef(name = "KazanilanTCKimlikNo", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
    protected JAXBElement<Long> kazanilanTCKimlikNo;
    @XmlElementRef(name = "KimlikNo", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "Uyruk", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
