    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "BelgeNo", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "DuzenlenmeTarih", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
    protected JAXBElement<TarihBilgisi> duzenlenmeTarih;
    @XmlElementRef(name = "DuzenleyenIlce", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
