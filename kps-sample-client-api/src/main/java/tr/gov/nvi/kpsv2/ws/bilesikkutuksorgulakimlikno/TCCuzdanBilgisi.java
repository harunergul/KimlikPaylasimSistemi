    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "CuzdanKayitNo", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
    protected JAXBElement<Long> cuzdanKayitNo;
    @XmlElementRef(name = "CuzdanVerilmeNeden", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "VerildigiIlce", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
