 ...
 *       &lt;sequence>
 *         &lt;element name="GeciciKimlikBilgisi" type="{http://kps.nvi.gov.tr/2011/01/01}TCGeciciKimlikBilgisi" minOccurs="0"/>
 *         &lt;element name="HataBilgisi" type="{http://kps.nvi.gov.tr/2011/01/01}Parametre" minOccurs="0"/>
 *         &lt;element name="KisiBilgisi" type="{http://kps.nvi.gov.tr/2011/01/01}TCKisiBilgisi" minOccurs="0"/>
 *         &lt;element name="NufusCuzdaniBilgisi" type="{http://kps.nvi.gov.tr/2011/01/01}TCCuzdanBilgisi" minOccurs="0"/>
 *         &lt;element name="TCKKBilgisi" type="{http://kps.nvi.gov.tr/2011/01/01}TCKK" minOccurs="0"/>
 *         &lt;element name="TCKKFotografBilgisi" type="{http://kps.nvi.gov.tr/2011/01/01}TCKKFotoBilgisi" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "GeciciKimlikBilgisi", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "KisiBilgisi", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
    protected JAXBElement<TCKisiBilgisi> kisiBilgisi;
    @XmlElementRef(name = "NufusCuzdaniBilgisi", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
    protected JAXBElement<TCCuzdanBilgisi> nufusCuzdaniBilgisi;
    @XmlElementRef(name = "TCKKBilgisi", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
    protected JAXBElement<TCKK> tckkBilgisi;
    @XmlElementRef(name = "TCKKFotografBilgisi", namespace = "http://kps.nvi.gov.tr/2011/01/01", type = JAXBElement.class)
